...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': BASE_DIR / 'logs' / 'bimflow.log',
        },
    },
    'loggers': {
        'bimflow': {
...
# Ensure logs folder exists (run once: python manage.py shell -c "from bimflow.settings import BASE_DIR; import os; os.makedirs(BASE_DIR / 'logs', exist_ok=True)")